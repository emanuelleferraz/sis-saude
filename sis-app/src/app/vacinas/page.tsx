...
import { atualizarVacina, criarVacina, deletarVacina, listarVacinas } from '@/services/vacinaService';
...
export default function VacinasPage({ onBack }: VacinasPageProps) {
  ...
  const [selectedVacina, setSelectedVacina] = useState<VacinaResponseDTO | null>(null);
        ...
        <DialogContent className="sm:max-w-125">
          ...
          <div className="grid gap-4 py-4">
            <div className="grid gap-2">
              ...
              <Input id="nome" placeholder="Digite o nome da vacina" value={nome} onChange={(e) => setNome(e.target.value)} />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="fabricante">Fabricante</Label>
              <Input id="fabricante" placeholder="Digite o fabricante da vacina" value={fabricante} onChange={(e) => setFabricante(e.target.value)} />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="dosagem">Dosagem</Label>
              <Input id="dosagem" placeholder="Digite a dosagem da vacina" value={dosagem} onChange={(e) => setDosagem(e.target.value)} />
            </div>
          </div>
          <DialogFooter>
        ...
        <DialogContent className="sm:max-w-125">
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Input id="edit-fabricante" value={fabricante} onChange={(e) => setFabricante(e.target.value)} />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="edit-dosagem">Dosagem</Label>
              <Input id="edit-dosagem" value={dosagem} onChange={(e) => setDosagem(e.target.value)} />
            </div>
          </div>
          <DialogFooter>
      ...
      <Dialog open={isDeleteOpen} onOpenChange={setIsDeleteOpen}>
        <DialogContent className="sm:max-w-100">
          <DialogHeader>
            ...
            <DialogDescription>
              Tem certeza que deseja excluir a vacina <strong>{selectedVacina?.nome}</strong>? Esta ação não pode ser desfeita.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
