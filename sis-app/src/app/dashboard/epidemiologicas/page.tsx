...
import {
  DashboardEpidemiologicaDTO,
  AlertaBairroDTO,
  DistribuicaoDoencaDTO,
  IncidenciaPorBairroDTO,
  TendenciaTrimestralDTO,
} from "@/types/dashboardDoenca";
...
export default function DashboardEpidemiologicas({
  onBack,
}: DashboardEpidemiologicasProps) {
  const [menuOpen, setMenuOpen] = useState(false);
  const [resumo, setResumo] = useState<
    DashboardEpidemiologicaDTO["resumo"] | null
  >(null);
  ...
  useEffect(() => {
    async function fetchDashboard() {
      try {
        setLoading(true);
        const data: DashboardEpidemiologicaDTO =
          await obterDashboardEpidemiologica();
